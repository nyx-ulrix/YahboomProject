...
const STOP_DISTANCCE_TEST_LAPTOP: LayoutItem[] = [
  { i: 'vit_decoder_widget',          x: 0,  y: 0, w: 4, h: 6 },
  { i: 'video_feed_widget',           x: 4,  y: 0, w: 4, h: 5 },
  { i: 'stop_test_bench_widget',      x: 10,  y: 0, w: 4, h: 6 },
  { i: 'stop_button_widget',          x: 4,  y: 5, w: 4, h: 1 },
  { i: 'event_log_widget',            x: 0,  y: 6, w: 12, h: 4 }
];
